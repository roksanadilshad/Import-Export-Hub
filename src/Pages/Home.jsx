...
const Home = () => {
    ...
    return (
        <div>
         ...
         <div className='relative  z-10'>
            ...
            <h4 className='lg:text-2xl  md:text-xl text-primary font-bold'>Connecting Global Markets, One Click at a Time</h4>
            <h2 className='lg:text-4xl xl:text-6 text-xl md:text-3xl text-white font-bold'>Discover, import, and export products worldwide <br/>
            <span className='lg:text-6xl xl:text-8xl md:text-6xl text-4xl text-accent font-bold' >— all from one seamless platform
                </span></h2>

                <a href='https://github.com/roksanadilshad' className='btn my-5  border-white btn-secondary text-white pt-1'>CONTACT ME<span><IoIosArrowForward></IoIosArrowForward></span></a>
    ...
    <section>
        <div className='lg:py-20 py-10'>
           ...
           <h2 className=' border-b-4 border-secondary w-60 lg:w-100 mx-auto  font-bold lg:text-4xl md:text-3xl text-2xl text-center text-accent '>LATEST PRODUCTS</h2>
        </div>
    ...
    <section>
        <div className='lg:py-20 py-10'>
           ...
           <h2 className=' border-b-4 border-secondary w-60 mx-auto  font-bold lg:text-4xl text-2xl text-center text-accent '>POPULAR PRODUCTS</h2>
        </div>
