  ...
  const handleSubmit = async(e) =>{
    ...
    return (
      ...
      <div className="card-body p-6 relative">
       <h2 className='border-b-4 border-secondary lg:w-80 w-70 mx-auto  font-bold text-2xl lg:text-4xl text-center text-accent my-5 lg:my-10'>ADD NEW PRODUCTS</h2>
