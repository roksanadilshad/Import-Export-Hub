...
const MyImports = () => {
  ...
  return (
    <div>
      ...
      <h2 className='border-b-4 border-secondary lg:w-120 w-70 mx-auto  font-bold text-2xl lg:text-4xl text-center text-accent my-5 lg:my-10'>MY IMPORT PRODUCTS</h2>
